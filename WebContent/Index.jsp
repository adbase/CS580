...
<link rel="stylesheet" type="text/css"
	href="views/css/bootstrap-datetimepicker.min.css">
		...
		<div class="row heightFill">
			...
			<div class="col-xs12 col-md-2 heightFill sidebar">
				...
				<ul class="nav nav-sidebar navbar-default heightFill">
					<li><a href="javascript:void(0)" onclick="loadXMLDoc('test')">
					...
					<li><a href="javascript:void(0)"
						onclick="loadXMLDoc('usermange')"><span
							class="glyphicon glyphicon-user"></span><span class="pull-center">用户管理</span>
					</a></li>
